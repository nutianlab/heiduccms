...
import com.heiduc.business.impl.pagefilter.BodyBeginPageFilter;
import com.heiduc.business.impl.pagefilter.HeadBeginPageFilter;
import com.heiduc.business.impl.pagefilter.HeadEndPageFilter;
import com.heiduc.business.impl.pagefilter.HtmlEndPageFilter;
import com.heiduc.business.impl.pagefilter.MetaPageFilter;
import com.heiduc.business.impl.pagefilter.PageFilter;
...
import com.heiduc.business.page.impl.SimplePageRenderDecorator;
import com.heiduc.business.page.impl.StructurePageRenderDecorator;
...
import com.heiduc.velocity.MyDateTool;
import com.heiduc.velocity.MyEscTool;
import com.heiduc.velocity.VelocityPluginService;
import com.heiduc.velocity.VelocityService;
import com.heiduc.velocity.impl.HeiducTool;
import com.heiduc.velocity.impl.VelocityPluginServiceImpl;
import com.heiduc.velocity.impl.VelocityServiceImpl;
...
public class PageBusinessImpl extends AbstractBusinessImpl 
	...
	public String render(PageEntity page, String template, 
			String languageCode) {
		HeiducContext.getInstance().getPageRenderingContext().setPage(page);
	...
	public List<String> validateBeforeUpdate(final PageEntity page) {
		...
		if (StringUtils.isEmpty(page.getFriendlyURL())) {
			...
			if (HeiducContext.getInstance().isSkipUrl(page.getFriendlyURL())) {
	...
	private boolean canReadPage(String url) {
		return !getBusiness().getContentPermissionBusiness().getPermission(
				url, HeiducContext.getInstance().getUser()).isDenied();
	}

	private boolean canWritePage(String url) {
		return getBusiness().getContentPermissionBusiness().getPermission(
				url, HeiducContext.getInstance().getUser()).isChangeGranted();
	}
	...
	private List<ContentEntity> securityFilter(String url, 
		...
		ContentPermissionEntity perm = getBusiness()
				...
				.getPermission(url, HeiducContext.getInstance().getUser());
