...
public class PluginLoader {
	...
	public void install(String filename, byte[] data) throws IOException, 
		...
		if (!war.containsKey(HEIDUC_PLUGIN)) {
			throw new PluginException(HEIDUC_PLUGIN + " not found");
		}
		PluginEntity plugin = readPluginConfig(war.get(HEIDUC_PLUGIN));
